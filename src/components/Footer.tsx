...
const Footer: React.FC<FooterProps> = ({ sections = [] }) => {
  return (
    <footer className="bg-blue-800 text-white">
      <div className="container mx-auto w-full py-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Logo and About Section */}
        <div className="p-4 md:p-0">
          <h2 className="text-4xl font-bold py-2">Sahayata</h2>
          ...
          <div className="flex mt-4 space-x-4 py-2">
            ...
            <a
              title="Instagram"
              href="https://instagram.com/p-s1dharth"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <div className="py-4 border-t border-gray-100 ">
        <p className="text-sm text-gray-100 text-center">
          &copy; {new Date().getFullYear()} Sahayata. All rights reserved.
        </p>
      </div>
    </footer>
  );
